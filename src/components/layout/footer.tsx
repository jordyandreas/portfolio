...
export function Footer() {
  ...
  return (
    <footer className="border-t border-border">
      <Container>
        <div className="flex flex-col items-center gap-3 py-10 text-center sm:gap-4 sm:py-12">
              ...
              return (
                <li key={link.href}>
                  <a
                    ...
                    className={cn(
                      "inline-flex size-10 items-center justify-center rounded-full bg-foreground text-background transition-[opacity,transform] duration-200 hover:opacity-90 hover:-translate-y-px active:translate-y-0 motion-reduce:transform-none",
                      focusRingClassName,
                    )}
                  >
